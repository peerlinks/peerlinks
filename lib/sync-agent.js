...
import WatchList from 'promise-waitlist';
...
export default class SyncAgent {
  constructor(channel, socket, options) {
    this.state = 'idle';
    ...
    this.timeoutWaitList = new WatchList();
    this.timeoutWatchers = new Set();
  ...
  destroy() {
    for (const entry of this.timeoutWatchers) {
      entry.cancel();
    }
  }
