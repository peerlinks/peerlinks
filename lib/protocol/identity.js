...
import Link, { EXPIRATION_DELTA as LINK_EXPIRATION_DELTA } from './link';
...
export default class Identity {
  ...
  issueLink(channel, { expiration, trusteePubKey, trusteeDisplayName }) {
    if (!expiration) {
