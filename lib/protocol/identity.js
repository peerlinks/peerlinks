...
export const INVITE_HASH_KEY = Buffer.from('peerlinks-invite');
...
export default class Identity {
  ...
  canInvite(channel, timestamp = now()) {
    ...
    return this.getChain(channel, timestamp).canAppend();
  }
  ...
  inviteRequestIdFor(publicKey) {
    ...
    this.sodium.crypto_generichash(requestId, publicKey, INVITE_HASH_KEY);
    return requestId;
  }
