...
export const PING_INTERVAL_MAX = 15000;
...
export default class Peer {
  ...
  async pingLoop() {
    for (;;) {
      const delay = PING_INTERVAL_MIN +
        (PING_INTERVAL_MAX - PING_INTERVAL_MIN) * Math.random();
      ...
      this.ping.entry = this.waitList.waitFor(`pong ${seq}`, PONG_TIMEOUT);
      await this.ping.entry.promise;
      this.ping.entry = null;
    }
  }
