...
export const EncryptedInvite = $root.EncryptedInvite = (() => {
    ...
    EncryptedInvite.encode = function encode(message, writer) {
        ...
        if (message.box != null && message.hasOwnProperty("box"))
            writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.box);
        return writer;
    };
...
export const InviteRequest = $root.InviteRequest = (() => {
     ...
     * @property {string|null} [peerId] InviteRequest peerId
     ...
     * @instance
     */
    InviteRequest.prototype.peerId = "";
...
export const ChannelMessage = $root.ChannelMessage = (() => {
    ...
    ChannelMessage.Text = (function() {
         ...
         * @implements IText
         * @constructor
         * @param {ChannelMessage.IText=} [properties] Properties to set
         */
         ...
         * @static
         * @param {ChannelMessage.IText=} [properties] Properties to set
         * @returns {ChannelMessage.Text} Text instance
         */
        ...
        /**
         * Encodes the specified Text message. Does not implicitly {@link ChannelMessage.Text.verify|verify} messages.
         * @function encode
         * @memberof ChannelMessage.Text
         * @static
         * @param {ChannelMessage.IText} message Text message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified Text message, length delimited. Does not implicitly {@link ChannelMessage.Text.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ChannelMessage.Text
         * @static
         * @param {ChannelMessage.IText} message Text message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ChannelMessage.Text} Text
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        Text.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChannelMessage.Text();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Text.fromObject = function fromObject(object) {
            if (object instanceof $root.ChannelMessage.Text)
                return object;
            let message = new $root.ChannelMessage.Text();
            if (object.text != null)
         ...
         * @memberof ChannelMessage.Text
         * @static
         * @param {ChannelMessage.Text} message Text
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    ChannelMessage.Body = (function() {
         ...
         * @property {ChannelMessage.IText|null} [text] Body text
         */
        ...
        /**
         * Body text.
         * @member {ChannelMessage.IText|null|undefined} text
         * @memberof ChannelMessage.Body
         * @instance
         */
        ...
        /**
         * Body body.
         * @member {"root"|"text"|undefined} body
         * @memberof ChannelMessage.Body
         * @instance
         */
        Object.defineProperty(Body.prototype, "body", {
            get: $util.oneOfGetter($oneOfFields = ["root", "text"]),
        ...
        Body.encode = function encode(message, writer) {
            ...
            if (message.text != null && message.hasOwnProperty("text"))
                $root.ChannelMessage.Text.encode(message.text, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
        ...
        Body.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    message.text = $root.ChannelMessage.Text.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        Body.verify = function verify(message) {
            ...
            if (message.text != null && message.hasOwnProperty("text")) {
                ...
                properties.body = 1;
                {
                    let error = $root.ChannelMessage.Text.verify(message.text);
                    if (error)
                        return "text." + error;
                }
            }
        ...
        Body.fromObject = function fromObject(object) {
            ...
            if (object.text != null) {
                if (typeof object.text !== "object")
                    throw TypeError(".ChannelMessage.Body.text: object expected");
                message.text = $root.ChannelMessage.Text.fromObject(object.text);
            }
            return message;
        };
        ...
        Body.toObject = function toObject(message, options) {
            ...
            if (message.text != null && message.hasOwnProperty("text")) {
                object.text = $root.ChannelMessage.Text.toObject(message.text, options);
                if (options.oneofs)
                    object.body = "text";
            }
            return object;
...
export const Subscribe = $root.Subscribe = (() => {
     ...
     * @property {Uint8Array|null} [channelId] Subscribe channelId
     */
     ...
     * @instance
     */
    Subscribe.prototype.channelId = $util.newBuffer([]);
...
export const Packet = $root.Packet = (() => {
     ...
     * @property {ISubscribe|null} [subscribe] Packet subscribe
     ...
     * @instance
     */
    Packet.prototype.subscribe = null;
    ...
    /**
     * Packet content.
     * @member {"invite"|"error"|"subscribe"|"query"|"queryResponse"|"bulk"|"bulkResponse"|"notification"|undefined} content
     * @memberof Packet
     * @instance
     */
    Object.defineProperty(Packet.prototype, "content", {
        get: $util.oneOfGetter($oneOfFields = ["invite", "error", "subscribe", "query", "queryResponse", "bulk", "bulkResponse", "notification"]),
        set: $util.oneOfSetter($oneOfFields)
    });
    ...
    Packet.encode = function encode(message, writer) {
        ...
        if (message.invite != null && message.hasOwnProperty("invite"))
            $root.EncryptedInvite.encode(message.invite, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        ...
        if (message.query != null && message.hasOwnProperty("query"))
            $root.Query.encode(message.query, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
        if (message.queryResponse != null && message.hasOwnProperty("queryResponse"))
            $root.QueryResponse.encode(message.queryResponse, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
        if (message.bulk != null && message.hasOwnProperty("bulk"))
            $root.Bulk.encode(message.bulk, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
        if (message.bulkResponse != null && message.hasOwnProperty("bulkResponse"))
            $root.BulkResponse.encode(message.bulkResponse, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
    ...
    Packet.fromObject = function fromObject(object) {
        ...
        if (object.subscribe != null) {
            if (typeof object.subscribe !== "object")
                throw TypeError(".Packet.subscribe: object expected");
    ...
    Identity.encode = function encode(message, writer) {
        ...
        if (message.channelChains != null && message.channelChains.length)
            for (let i = 0; i < message.channelChains.length; ++i)
                $root.Identity.ChannelChain.encode(message.channelChains[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
        return writer;
    };
...
export const ChannelList = $root.ChannelList = (() => {

    /**
     * Properties of a ChannelList.
     * @exports IChannelList
     * @interface IChannelList
     * @property {Array.<IChannel>|null} [channels] ChannelList channels
     */

    /**
     * Constructs a new ChannelList.
     * @exports ChannelList
     * @classdesc Represents a ChannelList.
     * @implements IChannelList
     * @constructor
     * @param {IChannelList=} [properties] Properties to set
     */
    function ChannelList(properties) {
        this.channels = [];
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
     ...
     * @instance
     */
    ChannelList.prototype.channels = $util.emptyArray;

    /**
     * Creates a new ChannelList instance using the specified properties.
     * @function create
     * @memberof ChannelList
     * @static
     * @param {IChannelList=} [properties] Properties to set
     * @returns {ChannelList} ChannelList instance
     */
    ChannelList.create = function create(properties) {
        return new ChannelList(properties);
    };

    /**
     * Encodes the specified ChannelList message. Does not implicitly {@link ChannelList.verify|verify} messages.
     * @function encode
     * @memberof ChannelList
     * @static
     * @param {IChannelList} message ChannelList message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ChannelList.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
    ...
    /**
     * Encodes the specified ChannelList message, length delimited. Does not implicitly {@link ChannelList.verify|verify} messages.
     * @function encodeDelimited
     * @memberof ChannelList
     * @static
     * @param {IChannelList} message ChannelList message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ChannelList.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a ChannelList message from the specified reader or buffer.
     * @function decode
     * @memberof ChannelList
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ChannelList} ChannelList
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ChannelList.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChannelList();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    /**
     * Decodes a ChannelList message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof ChannelList
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ChannelList.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
    ...
    /**
     * Verifies a ChannelList message.
     * @function verify
     * @memberof ChannelList
     * @static
     * @param {Object.<string,*>} message Plain object to verify
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ChannelList.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
    ...
    /**
     * Creates a ChannelList message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof ChannelList
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {ChannelList} ChannelList
     */
    ChannelList.fromObject = function fromObject(object) {
        if (object instanceof $root.ChannelList)
            return object;
        let message = new $root.ChannelList();
        if (object.channels) {
            if (!Array.isArray(object.channels))
                throw TypeError(".ChannelList.channels: array expected");
            message.channels = [];
            for (let i = 0; i < object.channels.length; ++i) {
                if (typeof object.channels[i] !== "object")
                    throw TypeError(".ChannelList.channels: object expected");
    ...
    /**
     * Creates a plain object from a ChannelList message. Also converts values to other types if specified.
     * @function toObject
     * @memberof ChannelList
     * @static
     * @param {ChannelList} message ChannelList
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ChannelList.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.arrays || options.defaults)
    ...
    /**
     * Converts this ChannelList to JSON.
     * @function toJSON
     * @memberof ChannelList
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    ChannelList.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
