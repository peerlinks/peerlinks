...
export const Packet = $root.Packet = (() => {
    ...
    /**
     * Packet content.
     * @member {"subscribe"|"error"|"invite"|"query"|"queryResponse"|"bulk"|"bulkResponse"|"notification"|undefined} content
     * @memberof Packet
     * @instance
     */
    Object.defineProperty(Packet.prototype, "content", {
        get: $util.oneOfGetter($oneOfFields = ["subscribe", "error", "invite", "query", "queryResponse", "bulk", "bulkResponse", "notification"]),
        set: $util.oneOfSetter($oneOfFields)
    });
    ...
    Packet.encode = function encode(message, writer) {
        ...
        if (message.invite != null && message.hasOwnProperty("invite"))
            $root.EncryptedInvite.encode(message.invite, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
