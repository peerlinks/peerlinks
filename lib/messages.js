...
export const ChannelMessage = $root.ChannelMessage = (() => {
    ...
    ChannelMessage.EncryptionKeyInput = (function() {
         ...
         * @property {number|Long|null} [height] EncryptionKeyInput height
         */
        ...
        /**
         * EncryptionKeyInput height.
         * @member {number|Long} height
         * @memberof ChannelMessage.EncryptionKeyInput
         * @instance
         */
        EncryptionKeyInput.prototype.height = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
